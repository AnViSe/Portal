...
class DatabaseWrapper(base.DatabaseWrapper):
    ...
    data_types.update({
        'AutoField': 'NUMBER(11) GENERATED BY DEFAULT ON NULL AS IDENTITY (NOCACHE)',
        'BigAutoField': 'NUMBER(19) GENERATED BY DEFAULT ON NULL AS IDENTITY (NOCACHE)',
        'SmallAutoField': 'NUMBER(5) GENERATED BY DEFAULT ON NULL AS IDENTITY (NOCACHE)',
